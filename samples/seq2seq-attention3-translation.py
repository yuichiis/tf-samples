...
class Seq2seq(tf.keras.Model):
    def __init__(self,
        ...
        **kwargs
        ...
        self.encoder = Encoder(input_vocab_size,  word_vect_size, recurrent_units)
        self.decoder = Decoder(target_vocab_size, word_vect_size, recurrent_units)
...
seq2seq = Seq2seq(
    ...
    word_vect_size=embedding_dim,
    recurrent_units=units,
